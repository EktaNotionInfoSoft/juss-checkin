          ...
          <div class="card card-primary">
              ...
              @endif
                ...
                <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fa fa-envelope mr-2"></i>Blogs</h3>
                    <div class="text-right">
                        <a href="{{ url('/admin/add_blog') }}" class="btn btn-primary pull-right addEmail"><span>+ Add Blog</span></a>
                    </div>
                </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Manage Blogs</h4>
