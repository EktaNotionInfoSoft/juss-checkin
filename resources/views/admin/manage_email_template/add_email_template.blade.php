          ...
          <div class="col-sm-12">    
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"> <i class="fas fa-plus"></i> Email Template</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('addEmailTemplateData') }}" method="POST" id="emailForm" >
                @csrf 
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" id="email_template_name" name="email_template_name" placeholder="Enter Email Template Name" >
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                      <textarea name="email_content" id="email_content" rows="10" cols="80"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
