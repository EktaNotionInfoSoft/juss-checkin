          ...
          <div class="card card-primary">
              ...
              @endif
                ...
                <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fa fa-envelope mr-2"></i>CMS Pages</h3>
                    <div class="text-right">
                        <a href="{{ url('/admin/add_cms') }}" class="btn btn-primary pull-right addEmail"><span>+ Add CMS </span></a>
                    </div>
                </div>
                <div class="container mt-5">
                  <table class="table table-bordered cms-datatable">
                    <thead>
                      <tr>
                        <th>Page Name</th>
                        <th>Page Title</th>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Manage Cms</h4>
