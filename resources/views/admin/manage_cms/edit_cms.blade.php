        ...
        <div class="row">      
          <div class="col-sm-12">    
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('updateCms') }}" method="POST" id="cmsForm" >
                @csrf 
                <input type="hidden" name="id" value="{{ $cms->id}}">
                <input type="hidden" name="status" value="{{ $cms->status}}">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Cms Name" value="{{ $cms->name}}" >
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                      <textarea name="description" id="description" rows="10" cols="80">{{ $cms->description}}</textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
